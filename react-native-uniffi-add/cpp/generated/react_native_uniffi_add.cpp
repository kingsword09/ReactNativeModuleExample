...
// it!
#include "react_native_uniffi_add.hpp"
...
uint64_t
uniffi_react_native_uniffi_add_fn_func_add(uint64_t left, uint64_t right,
                                           RustCallStatus *uniffi_out_err);
RustBuffer
ffi_react_native_uniffi_add_rustbuffer_alloc(uint64_t size,
                                             RustCallStatus *uniffi_out_err);
RustBuffer ffi_react_native_uniffi_add_rustbuffer_from_bytes(
    ForeignBytes bytes, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rustbuffer_free(
    RustBuffer buf, RustCallStatus *uniffi_out_err);
RustBuffer ffi_react_native_uniffi_add_rustbuffer_reserve(
    RustBuffer buf, uint64_t additional, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_u8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_u8(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_u8(
    /*handle*/ uint64_t handle);
uint8_t ffi_react_native_uniffi_add_rust_future_complete_u8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_i8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_i8(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_i8(
    /*handle*/ uint64_t handle);
int8_t ffi_react_native_uniffi_add_rust_future_complete_i8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_u16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_u16(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_u16(
    /*handle*/ uint64_t handle);
uint16_t ffi_react_native_uniffi_add_rust_future_complete_u16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_i16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_i16(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_i16(
    /*handle*/ uint64_t handle);
int16_t ffi_react_native_uniffi_add_rust_future_complete_i16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_u32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_u32(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_u32(
    /*handle*/ uint64_t handle);
uint32_t ffi_react_native_uniffi_add_rust_future_complete_u32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_i32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_i32(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_i32(
    /*handle*/ uint64_t handle);
int32_t ffi_react_native_uniffi_add_rust_future_complete_i32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_u64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_u64(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_u64(
    /*handle*/ uint64_t handle);
uint64_t ffi_react_native_uniffi_add_rust_future_complete_u64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_i64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_i64(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_i64(
    /*handle*/ uint64_t handle);
int64_t ffi_react_native_uniffi_add_rust_future_complete_i64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_f32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_f32(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_f32(
    /*handle*/ uint64_t handle);
float ffi_react_native_uniffi_add_rust_future_complete_f32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_f64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_f64(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_f64(
    /*handle*/ uint64_t handle);
double ffi_react_native_uniffi_add_rust_future_complete_f64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_pointer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_pointer(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_pointer(
    /*handle*/ uint64_t handle);
void *ffi_react_native_uniffi_add_rust_future_complete_pointer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_rust_buffer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_rust_buffer(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_rust_buffer(
    /*handle*/ uint64_t handle);
RustBuffer ffi_react_native_uniffi_add_rust_future_complete_rust_buffer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_react_native_uniffi_add_rust_future_poll_void(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_react_native_uniffi_add_rust_future_cancel_void(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_free_void(
    /*handle*/ uint64_t handle);
void ffi_react_native_uniffi_add_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint16_t uniffi_react_native_uniffi_add_checksum_func_add();
uint32_t ffi_react_native_uniffi_add_uniffi_contract_version();
}

// This calls into Rust.

namespace uniffi::react_native_uniffi_add {
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::react_native_uniffi_add::Bridging<T>::fromJs(
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_react_native_uniffi_add_rustbuffer_alloc(size, &status);
  }
  ...
  static RustBuffer fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker>,
    ...
    try {
      ...
      RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
      auto buf =
          ffi_react_native_uniffi_add_rustbuffer_from_bytes(bytes, &status);
  ...
  static jsi::Value toJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker>,
    ...
    ffi_react_native_uniffi_add_rustbuffer_free(buf, &status);
...
// Callback function:
// uniffi::react_native_uniffi_add::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
namespace uniffi::react_native_uniffi_add::cb::rustfuturecontinuationcallback {
using namespace facebook;
...
makeCallbackFunction( // uniffi::react_native_uniffi_add::cb::rustfuturecontinuationcallback
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
...
// This method is called from the destructor of NativeReactNativeUniffiAdd,
...
static void cleanup() {
  ...
  // uniffi::react_native_uniffi_add::cb::rustfuturecontinuationcallback
...
// Callback function:
// uniffi::react_native_uniffi_add::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::react_native_uniffi_add::st::foreignfuture::foreignfuture::
    free {
using namespace facebook;
...
makeCallbackFunction( // uniffi::react_native_uniffi_add::st::foreignfuture::foreignfuture::free
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  auto callbackFunction = value.asObject(rt).asFunction(rt);
...
static void cleanup() {
  ...
  // uniffi::react_native_uniffi_add::st::foreignfuture::foreignfuture::free
namespace uniffi::react_native_uniffi_add {
using namespace facebook;
using CallInvoker = uniffi_runtime::UniffiCallInvoker;
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::react_native_uniffi_add::st::foreignfuture::
...
template <> struct Bridging<UniffiForeignFutureStructU8> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.call_status =
        uniffi::react_native_uniffi_add::Bridging<RustCallStatus>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::react_native_uniffi_add::Bridging<
...
template <> struct Bridging<UniffiForeignFutureStructRustBuffer> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.return_value =
        uniffi::react_native_uniffi_add::Bridging<RustBuffer>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "returnValue"));
    rsObject.call_status =
        uniffi::react_native_uniffi_add::Bridging<RustCallStatus>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "callStatus"));
...
NativeReactNativeUniffiAdd::NativeReactNativeUniffiAdd(
    jsi::Runtime &rt,
  ...
  props["uniffi_react_native_uniffi_add_fn_func_add"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_react_native_uniffi_add_fn_func_add"),
          2,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_react_native_uniffi_add_fn_func_add(
                rt, thisVal, args, count);
          });
  props["uniffi_react_native_uniffi_add_checksum_func_add"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_react_native_uniffi_add_checksum_func_add"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_react_native_uniffi_add_checksum_func_add(
                rt, thisVal, args, count);
          });
  props["ffi_react_native_uniffi_add_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ffi_react_native_uniffi_add_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_ffi_react_native_uniffi_add_uniffi_contract_version(
                    rt, thisVal, args, count);
          });
}

void NativeReactNativeUniffiAdd::registerModule(
    jsi::Runtime &rt, std::shared_ptr<react::CallInvoker> callInvoker) {
  auto invoker =
      std::make_shared<uniffi_runtime::UniffiCallInvoker>(callInvoker);
  auto tm = std::make_shared<NativeReactNativeUniffiAdd>(rt, invoker);
  auto obj = rt.global().createFromHostObject(rt, tm);
  rt.global().setProperty(rt, "NativeReactNativeUniffiAdd", obj);
}

void NativeReactNativeUniffiAdd::unregisterModule(jsi::Runtime &rt) {
  // NOOP
}

jsi::Value NativeReactNativeUniffiAdd::get(jsi::Runtime &rt,
...
NativeReactNativeUniffiAdd::getPropertyNames(jsi::Runtime &rt) {
...
void NativeReactNativeUniffiAdd::set(jsi::Runtime &rt,
                                     const jsi::PropNameID &name,
                                     const jsi::Value &value) {
...
jsi::Value NativeReactNativeUniffiAdd::
...
jsi::Value
NativeReactNativeUniffiAdd::cpp_uniffi_react_native_uniffi_add_fn_func_add(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::react_native_uniffi_add::Bridging<RustCallStatus>::rustSuccess(
          rt);
  auto value = uniffi_react_native_uniffi_add_fn_func_add(
      uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
      uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[1]),
      &status);
  uniffi::react_native_uniffi_add::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);

  return uniffi_jsi::Bridging<uint64_t>::toJs(rt, callInvoker, value);
}
jsi::Value NativeReactNativeUniffiAdd::
    cpp_uniffi_react_native_uniffi_add_checksum_func_add(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_react_native_uniffi_add_checksum_func_add();
...
jsi::Value NativeReactNativeUniffiAdd::
    cpp_ffi_react_native_uniffi_add_uniffi_contract_version(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = ffi_react_native_uniffi_add_uniffi_contract_version();
