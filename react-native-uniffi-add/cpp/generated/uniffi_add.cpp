...
uint64_t uniffi_uniffi_add_fn_func_add(uint64_t left, uint64_t right,
                                       RustCallStatus *uniffi_out_err);
RustBuffer ffi_uniffi_add_rustbuffer_alloc(uint64_t size,
                                           RustCallStatus *uniffi_out_err);
RustBuffer ffi_uniffi_add_rustbuffer_from_bytes(ForeignBytes bytes,
                                                RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rustbuffer_free(RustBuffer buf,
                                    RustCallStatus *uniffi_out_err);
RustBuffer ffi_uniffi_add_rustbuffer_reserve(RustBuffer buf,
                                             uint64_t additional,
                                             RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_u8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_u8(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_u8(
    /*handle*/ uint64_t handle);
uint8_t ffi_uniffi_add_rust_future_complete_u8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_i8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_i8(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_i8(
    /*handle*/ uint64_t handle);
int8_t ffi_uniffi_add_rust_future_complete_i8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_u16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_u16(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_u16(
    /*handle*/ uint64_t handle);
uint16_t ffi_uniffi_add_rust_future_complete_u16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_i16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_i16(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_i16(
    /*handle*/ uint64_t handle);
int16_t ffi_uniffi_add_rust_future_complete_i16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_u32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_u32(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_u32(
    /*handle*/ uint64_t handle);
uint32_t ffi_uniffi_add_rust_future_complete_u32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_i32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_i32(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_i32(
    /*handle*/ uint64_t handle);
int32_t ffi_uniffi_add_rust_future_complete_i32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_u64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_u64(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_u64(
    /*handle*/ uint64_t handle);
uint64_t ffi_uniffi_add_rust_future_complete_u64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_i64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_i64(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_i64(
    /*handle*/ uint64_t handle);
int64_t ffi_uniffi_add_rust_future_complete_i64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_f32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_f32(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_f32(
    /*handle*/ uint64_t handle);
float ffi_uniffi_add_rust_future_complete_f32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_f64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_f64(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_f64(
    /*handle*/ uint64_t handle);
double ffi_uniffi_add_rust_future_complete_f64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_pointer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_pointer(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_pointer(
    /*handle*/ uint64_t handle);
void *ffi_uniffi_add_rust_future_complete_pointer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_rust_buffer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_rust_buffer(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_rust_buffer(
    /*handle*/ uint64_t handle);
RustBuffer ffi_uniffi_add_rust_future_complete_rust_buffer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_uniffi_add_rust_future_poll_void(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_uniffi_add_rust_future_cancel_void(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_free_void(
    /*handle*/ uint64_t handle);
void ffi_uniffi_add_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint16_t uniffi_uniffi_add_checksum_func_add();
uint32_t ffi_uniffi_add_uniffi_contract_version();
}

// This calls into Rust.

namespace uniffi::uniffi_add {
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::uniffi_add::Bridging<T>::fromJs(rt, callInvoker, pointee);
    }
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_uniffi_add_rustbuffer_alloc(size, &status);
  }
  ...
  static RustBuffer fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker>,
    ...
    try {
      ...
      RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
      auto buf = ffi_uniffi_add_rustbuffer_from_bytes(bytes, &status);
  ...
  static jsi::Value toJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker>,
    ...
    ffi_uniffi_add_rustbuffer_free(buf, &status);
...
// Callback function:
// uniffi::uniffi_add::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
namespace uniffi::uniffi_add::cb::rustfuturecontinuationcallback {
using namespace facebook;
...
makeCallbackFunction( // uniffi::uniffi_add::cb::rustfuturecontinuationcallback
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
...
// This method is called from the destructor of NativeUniffiAdd, which only
...
// Callback function:
// uniffi::uniffi_add::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::uniffi_add::st::foreignfuture::foreignfuture::free {
using namespace facebook;
...
makeCallbackFunction( // uniffi::uniffi_add::st::foreignfuture::foreignfuture::free
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  auto callbackFunction = value.asObject(rt).asFunction(rt);
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::uniffi_add::st::foreignfuture::foreignfuture::free::
...
template <> struct Bridging<UniffiForeignFutureStructU8> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.call_status = uniffi::uniffi_add::Bridging<RustCallStatus>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructU8>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteI8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructI8>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU16> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructU16>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI16> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructI16>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructU32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructI32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteU64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructU64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteI64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructI64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteF32> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructF32>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompleteF64> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructF64>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureCompletePointer> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructPointer>::fromJs(
             rt, callInvoker, args[1]));
...
template <> struct Bridging<UniffiForeignFutureStructRustBuffer> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    // Create the vtable from the js callbacks.
    rsObject.return_value = uniffi::uniffi_add::Bridging<RustBuffer>::fromJs(
        rt, callInvoker, jsObject.getProperty(rt, "returnValue"));
    rsObject.call_status = uniffi::uniffi_add::Bridging<RustCallStatus>::fromJs(
        rt, callInvoker, jsObject.getProperty(rt, "callStatus"));
...
template <> struct Bridging<UniffiForeignFutureCompleteVoid> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::uniffi_add::Bridging<UniffiForeignFutureStructVoid>::fromJs(
             rt, callInvoker, args[1]));
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    try {
      static auto callback =
          uniffi::uniffi_add::cb::rustfuturecontinuationcallback::
...
NativeUniffiAdd::NativeUniffiAdd(
    jsi::Runtime &rt,
  ...
  props["uniffi_uniffi_add_fn_func_add"] =
      jsi::Function::createFromHostFunction(
          rt, jsi::PropNameID::forAscii(rt, "uniffi_uniffi_add_fn_func_add"), 2,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_uniffi_add_fn_func_add(rt, thisVal, args,
                                                           count);
          });
  props["uniffi_uniffi_add_checksum_func_add"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "uniffi_uniffi_add_checksum_func_add"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_uniffi_add_checksum_func_add(rt, thisVal,
                                                                 args, count);
          });
  props["ffi_uniffi_add_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt,
                                    "ffi_uniffi_add_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_uniffi_add_uniffi_contract_version(
                rt, thisVal, args, count);
          });
}

void NativeUniffiAdd::registerModule(
    jsi::Runtime &rt, std::shared_ptr<react::CallInvoker> callInvoker) {
  auto invoker =
      std::make_shared<uniffi_runtime::UniffiCallInvoker>(callInvoker);
  auto tm = std::make_shared<NativeUniffiAdd>(rt, invoker);
  auto obj = rt.global().createFromHostObject(rt, tm);
  rt.global().setProperty(rt, "NativeUniffiAdd", obj);
}

void NativeUniffiAdd::unregisterModule(jsi::Runtime &rt) {
  // NOOP
}

jsi::Value NativeUniffiAdd::get(jsi::Runtime &rt, const jsi::PropNameID &name) {
  try {
...
NativeUniffiAdd::getPropertyNames(jsi::Runtime &rt) {
...
void NativeUniffiAdd::set(jsi::Runtime &rt, const jsi::PropNameID &name,
                          const jsi::Value &value) {
...
NativeUniffiAdd::~NativeUniffiAdd() {
  ...
  uniffi::uniffi_add::cb::rustfuturecontinuationcallback::cleanup();
  // Cleanup for "free" callback function CallbackInterfaceFree
  uniffi::uniffi_add::st::foreignfuture::foreignfuture::free::cleanup();
}

// Utility functions for serialization/deserialization of strings.
jsi::Value
NativeUniffiAdd::cpp_uniffi_internal_fn_func_ffi__string_to_byte_length(
...
jsi::Value
NativeUniffiAdd::cpp_uniffi_internal_fn_func_ffi__string_to_arraybuffer(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value
NativeUniffiAdd::cpp_uniffi_internal_fn_func_ffi__arraybuffer_to_string(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value NativeUniffiAdd::cpp_uniffi_uniffi_add_fn_func_add(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::uniffi_add::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_uniffi_add_fn_func_add(
      uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
      uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[1]),
      &status);
  uniffi::uniffi_add::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);

  return uniffi_jsi::Bridging<uint64_t>::toJs(rt, callInvoker, value);
}
jsi::Value NativeUniffiAdd::cpp_uniffi_uniffi_add_checksum_func_add(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = uniffi_uniffi_add_checksum_func_add();

  return uniffi_jsi::Bridging<uint16_t>::toJs(rt, callInvoker, value);
}
jsi::Value NativeUniffiAdd::cpp_ffi_uniffi_add_uniffi_contract_version(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  auto value = ffi_uniffi_add_uniffi_contract_version();
